...
enum class WindowFlag(val i: WindowFlags) {
...
enum class InputTextFlag(val i: InputTextFlags) { // TODO Int -> *flags the others enum
...
enum class TreeNodeFlag(val i: TreeNodeFlags) {
...
enum class PopupFlag(val i: PopupFlags) {
...
enum class SelectableFlag(val i: SelectableFlags) {
...
enum class ComboFlag(val i: ComboFlags) {
    None(0),
...
enum class TabBarFlag(val i: TabBarFlags) {
    None(0),
...
enum class TabItemFlag(val i: TabItemFlags) {
    None(0),
...
enum class TableRowFlag(val i: Int) {
    None(0),
...
enum class TableBgTarget(val i: TableBgTargets) {
    None(0),
...
enum class FocusedFlag(val i: FocusedFlags) {
    None(0),
...
enum class HoveredFlag(val i: HoveredFlags) {
...
enum class DragDropFlag(val i: DragDropFlags) {
...
enum class ConfigFlag(val i: ConfigFlags) {
    None(0),
...
enum class BackendFlag(val i: BackendFlags) {
    None(0),
...
operator fun ArrayList<Vec4>.set(idx: Col, vec: Vec4) = this[idx.i].set(vec)
...
enum class ColorEditFlag(val i: ColorEditFlags) {
...
enum class Cond(val i: CondFlags) {
