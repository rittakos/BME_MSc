...
$$ NPS = \lim_{N_x,N_y,M \rightarrow \infty}{{1}\over{X\cdot Y}}  \left< | F \lbrace I^{(1:M)} - \overline{I} \rbrace |^2 \right>$$
...
$$ NPS = \lim_{N_x,N_y,M \rightarrow \infty}{{\Delta x \cdot \Delta y}\over{N_x\cdot N_y}}  \left< | F \lbrace I^{(1:M)} - \overline{I} \rbrace |^2 \right>$$
